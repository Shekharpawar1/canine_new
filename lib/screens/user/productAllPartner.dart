...
class UserProductAllPartner extends StatelessWidget {
  ...
  final VideoBannerController videobannercontroller =
  Get.put(VideoBannerController());
  // @override
  // void onInit() {
          ...
          child: SingleChildScrollView(
            child: Column(
              children: [
                Center(
                  child: FutureBuilder(
                    future: videobannercontroller.videoPlayerController1.initialize(),
                    builder: (context, snapshot) {
                      if (snapshot.connectionState == ConnectionState.done) {
                        // Ensure the first video is initialized and starts playing
                        videobannercontroller.videoPlayerController1.play();
                        return AspectRatio(
                          aspectRatio: videobannercontroller.videoPlayerController1.value.aspectRatio,
                          child: VideoPlayer(videobannercontroller.videoPlayerController1),
                        );
                      } else {
                ...
                GetBuilder<VideoBannerController>(
                    init:
                    videobannercontroller, // Ensure videobannercontroller is properly initialized.
                    builder: (_) {
                      return Column(
                        children: [
                          ...
                          ListView.builder(
                            //  primary: true,
                              ...
                              itemCount: videobannercontroller
                                  .userpartnerbannerModel!.data!.length,
                              itemBuilder: (context, index) {
                                final item = videobannercontroller
                                    .userpartnerbannerModel!.data![index];
                                var type1 = item.type;
                                final imageUrl =
                                    "${Constants.BASE_URL}/storage/app/${item.advertisement ?? ''}";
                                if (item == null) {
                                ...
                                return
                                  ...
                                  (type1 == 'banner')
                                    ...
                                    errorWidget: (context, url, error) =>
                                      ...
                                      : (type1 == 'banner')
                                      ? Center(
                                    child: videobannercontroller
                                        .videoPlayerController
                                        .value
                                        .isInitialized
                                        ? AspectRatio(
                                      aspectRatio:
                                      videobannercontroller
                                          .videoPlayerController
                                          .value
                                          .aspectRatio,
                                      child: VideoPlayer(
...
void shareContent(String image, String name, String detials) {
  ...
  String sharedText =
      '${Constants.BASE_URL}/storage/app/public/product/${imageUrl ?? ""}\n$text\n$description';
