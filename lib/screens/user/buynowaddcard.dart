...
import 'package:canine/screens/user/paymentbuynow.dart';
import 'package:canine/screens/user/userHome.dart';
import 'package:canine/screens/user/useraddnewAddress.dart';
import 'package:canine/screens/user/usercouponPage.dart';
                      ...
                      child: Padding(
                        ...
                        child: Column(children: [
                          ...
                          (couponsController.maxAmount == null ||
                              couponsController.maxAmount == "0.0" ||
                            ...
                            children: [
                              ...
                              const Spacer(),
                              (((widget.data!.price!)) <
                                  addtocartController.deliverycharges)
                                  ? Text(
                                "+ ₹" +
                                    (addtocartController
                                        .deliveryprice)
                                                                    ...
                                                                    Row(children: [
                                                                      ...
                                                                      GestureDetector(
                                                                        ...
                                                                        child: Container(
                                                                            ...
                                                                            BorderRadius.circular(15), border: Border.all(color: MyColors.grey)),
                                                                            child: Padding(
                                                                              padding: const EdgeInsets.all(3.0),
                                                                              child: Center(
                                                                                  child: Text(
