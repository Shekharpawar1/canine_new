                            ...
                            builder: (_) {
                              return wholenotificationcontroller
                                  ...
                                  : Positioned(
                                      ...
                                      right: 4.0,
                                      child: Center(
                                        child: wholenotificationcontroller
                                                    .wholeNotifyListModel ==
                                                null
                                            ? Center(
                                                child: SpinKitCircle(
...
class CustomAppBarWholeback extends StatelessWidget
...
// (getCardModel!.data!.isEmpty)?
// SizedBox():
            mycartController.wholemycartmodel == null ||
                    ...
                    child: Stack(
                      children: <Widget>[
                        ...
                        GetBuilder<MyCartWholeController>(
                            init: mycartController,
                            builder: (_) {
                              return mycartController.wholemycartmodel ==
                                          null ||
                                      mycartController.wholemycartmodel!.data ==
                                          null ||
                                      mycartController
                                  ...
                                  : Positioned(
                                      ...
                                      child: Center(
                                        child: Text(
                                          (mycartController.wholemycartmodel!
                                                  .data!.length)
                                              .toString(),
                                          // list.length.toString(),
                                          style: TextStyle(
...
class CustomAppBarWholeOnlyback extends StatelessWidget
    implements PreferredSizeWidget {
  // final GlobalKey<ScaffoldState> drawerKey;
  final title;
                ...
                child: Stack(
                  children: <Widget>[
                    ...
                    GetBuilder<MyCartWholeController>(
                        ...
                        builder: (_) {
                          return mycartwholeController.wholemycartmodel ==
                                      null ||
