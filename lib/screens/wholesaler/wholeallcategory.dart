                  ...
                  child: GetBuilder<WholeSubCategoryController>(
                      ...
                      builder: (_) {
                        return ListView.builder(
                          ...
                          shrinkWrap: true,
                          itemCount: wholesubcategorycontroller.wholesubmodel!.data!.length,
                          itemBuilder: (context, index) {
                            //  final isSelected = subcategorycontroller.selectedIndex == index;

                            var item = wholesubcategorycontroller.wholesubmodel!.data![index];

                            // print(item.name!);

                            var imagePath = "${Constants.BASE_URL}${Constants.CATEGORIES_IMAGE_PATH}${item.image ?? ""}";
                                ...
                                : Padding(
                                    ...
                                    child: InkWell(
                                      onTap: () {
                                        ...
                                        wholesubcategorycontroller.updateSelectedIndex(item.id ?? 0);
                                        print("===>${item.id}");
                                      ...
                                      child: Container(
                                        ...
                                        // width: 180,
                                        decoration: BoxDecoration(
                                            color: (wholesubcategorycontroller.selectedIndex == item.id)
                                                ? MyColors.yellow
                                                : Colors.white,
                         ...
                         GridView.builder(
                            ...
                            gridDelegate:
                                SliverGridDelegateWithFixedCrossAxisCount(
                                    ...
                                    mainAxisExtent: 285),
                            itemCount: wholesubcategorycontroller.wholeProductModel!.data!.length, // Set the number of cards you want to display.
                            itemBuilder: (context, index) {
                              // gridDelegate:
                              ...
                              var item = wholesubcategorycontroller.wholeProductModel!.data![index];
                              print(item);
                              var imagePath = "${Constants.BASE_URL}/storage/app/public/product/${item.image ?? ""}";
                              ...
                              return
                                  ...
                                  //   )
                                  // :
                                  wholesubcategorycontroller.wholeProductModel!.data == null
