...
import 'package:canine/controllers/wholesaler_controller/notification_controller.dart';
...
import 'package:canine/controllers/wholesaler_controller/profilewhole_controller.dart';
import 'package:canine/controllers/wholesaler_controller/subcateogries_controller.dart';
import 'package:canine/controllers/wholesaler_controller/wholesalerFilterController.dart';
import 'package:canine/controllers/wholesaler_controller/wholesaler_ourbrand_filter_controller.dart';
import 'package:canine/models/wholesalerModel/bannerModel.dart' as Banner;
import 'package:canine/others/Filter.dart';
import 'package:canine/screens/wholesaler/WholeAllbrandPage.dart';
...
import 'package:canine/screens/wholesaler/wholeallcategory.dart';
...
import 'package:canine/screens/wholesaler/ProductAlllistPage.dart';
...
class _HomeWholeState extends State<HomeWhole> {
  ...
  WholeSubCategoryController wholesubcategorycontroller = Get.put(WholeSubCategoryController());
              ...
              children: [
                      ...
                      child:ClipOval (
                        ...
                        child: CachedNetworkImage(
                          imageUrl: "${Constants.USERPROFILE_IMAGEPATH_URL}" +
                              wholeProfileController.wholemyprofilemodel!.data![0].image.toString(),
                ...
                SizedBox(
                  ...
                  wholehomecontroller == null? Center(
                                          child: SpinKitCircle(
                                            color: Colors.grey, // Color of the progress bar
                                            size: 20.0, // Size of the progress bar
                                          ),
                                        ):
                            ...
                            builder: (_) {
                              return !wholehomecontroller.categoryLoaded
                                  ...
                                  : ListView.builder(
                                      ...
                                      scrollDirection: Axis.horizontal,
                                      shrinkWrap: true,
                                      itemCount: wholehomecontroller.userCategoriesModel!.data!.length,
                                      itemBuilder: (context, index) {
                                        ...
                                        return Padding(
                                          ...
                                          child: InkWell(
                                            onTap: () async {
                                              wholesubcategorycontroller.addproduct(item.id ?? 0);
                                              wholesubcategorycontroller.currentCategory(item.name ?? "");
                                              await wholesubcategorycontroller.productInitByCategory();
                                                  ...
                                                  Container(
                                                    child: CachedNetworkImage(
                                                      ...
                                                      errorWidget: (context, url,
                                                              error) => Icon(Icons.error), // Replace with your own error widget
                                                    ),
                                                  ),
                                                  SizedBox(
                                                    height: 5,
                                      ...
                                      child: GridView.builder(
                                          ...
                                          gridDelegate:
                                              SliverGridDelegateWithFixedCrossAxisCount(
                                                  ...
                                                  mainAxisExtent: 285),
                                          itemCount: wholehomecontroller.userPropertiesModel!.data!.length.clamp(0, 4), // Set the number of cards you want to display.
                                          itemBuilder: (context, index) {
                                            // gridDelegate:
                                              ...
                                              child:
                                                ...
                                                child: Column(
                                                  children: [
                                                    Row(
                                                        children:[
                                                          IconButton(icon: Icon(Icons.share,size:20,color:MyColors.red),
                                                            onPressed: () {
                                                            shareContent(item.image.toString(), item.name.toString(),  item.price.toString());// Share.share(itemAll.toString());
                                                            },
                                                          ),
                                                          Spacer(),
                                                          InkWell(onTap: () {
                                                    ...
                                                    Container(
                                                      ...
                                                      child: Padding(
                                                        ...
                                                        child: Column(
                                                          ...
                                                          children: [
                                                            Text(item.name??'',
                                                           maxLines: 1, overflow: TextOverflow.ellipsis, style: CustomTextStyle.popinsmedium),
                                                            Text(
                                                                item.description.toString().length < 18 ?
                                                                  ...
                                                                  children: [
                                                                    ...
                                                                    Row(
                                                                      ...
                                                                      children: [
                                                                        ...
                                                                        InkWell(
                                                                          onTap: () async{
                                                                              wholeproductdetailsController.viewproductHome(item.id??0,item.name??'',"1kg",1 ,double.parse(item.wholePrice ?? ''),item.image??'',"yes");
                                                                          ...
                                                                          child: Padding(
                                                                            ...
                                                                            child: Container(
                                                                                ...
                                                                                child: Padding(
                                                                                  ...
                                                                                  child: Image.asset(
                                                                                    "assets/image/bag2.png", height: 25,
                                                                                  ),
                                                                                )),
                                                                          ),
                                                                        )
