...
import 'package:canine/models/wholesalerModel/orderDetailsModel.dart'as orderDetails;
import 'package:canine/controllers/wholesaler_controller/couponswhole_controller.dart';
import 'package:canine/controllers/wholesaler_controller/myOrder_controller.dart';
import 'package:canine/controllers/wholesaler_controller/order_tracker_controller.dart';
...
import 'package:canine/screens/wholesaler/locationScreenWhole.dart';
import 'package:canine/screens/wholesaler/locationScreenWholesaler.dart';
import 'package:canine/screens/wholesaler/notification.dart';
import 'package:canine/screens/wholesaler/ordersummary.dart';
import 'package:canine/screens/wholesaler/pdfView.dart';
...
import '../../controllers/wholesaler_controller/profilewhole_controller.dart';
import '../../models/partnerModel/orderDetailsModel.dart';
import '../../models/wholesalerModel/wholemyprofileModel.dart';
import '../../models/wholesalerModel/wholemyprofileModel.dart';
...
class _OrderDetailswholeState extends State<OrderDetailswhole> {
  ...
  final WholeReviewController wholereviewcontroller = Get.put(WholeReviewController());
  ...
  void generateAndOpenPDF(BuildContext context, total_add_on) async {

    var status = await Permission.storage.status;
    if (!status.isGranted) {
      await Permission.storage.request();
    }
    print("total sub${widget.itemTotal.toString()}");

    final pdf = pw.Document();
    final image =  await rootBundle.load('assets/image/background.png');


    // final dividerImageData = (await rootBundle.load("assets/image/divider.png")).buffer.asUint8List();
    // final dividerImage = pw.MemoryImage(dividerImageData);

    final logoImageData = (await rootBundle.load("assets/logo/logo.png")).buffer.asUint8List();
            ...
            child: pw.Column(
              children: [
                ...
                pw.Padding(
                  ...
                  child: pw.Divider(indent: 1, thickness: 1),
                ),
                //     pw.Row(
                ...
                //   // shrinkWrap: true,
                //    children: wholemyordercontroller!.wholeorderdetailsModel!.data!.map((e) => pw.Container(
                //   child: pw.Column(
                //     children: [
                //       pw.Row(
                //         mainAxisAlignment:
                        ...
                        children: [
                          pw.Row(
                            ...
                            children: [
                              ...
                              pw.Text(widget.variation.toString().replaceAll(RegExp(r'(\\n|\\|\"|\"\")'), ''),
                                  //     ? widget.variant!
                                  //     : "${widget.variant!.substring(0, 35).replaceAll(RegExp(r'(\\n|\\|\"|\"\")'), '')}",
                          ...
                          pw.Row(
                            mainAxisAlignment: pw.MainAxisAlignment.spaceBetween,
                            children: [
                              pw.Text("Variant", style: pw.TextStyle(fontSize: 14)),
                              pw.Text(
                                  "${widget.variation.toString().replaceAll(RegExp(r'(\\n|\\|\"|\"\")'), '')}",
                                  style: pw.TextStyle(
                                    fontSize: 14,
                                    // fontWeight: pw.FontWeight.w500,
                                  ))
                          ...
                          pw.Row(
                            ...
                            children: [
                              ...
                              pw.Text("${widget.itemQuantity.toString()}",
                                  style: pw.TextStyle(
                                    fontSize: 14,
                                    // fontWeight: pw.FontWeight.w500,
                                  ))
                          ...
                          pw.Row(
                            ...
                            children: [
                              ...
                              pw.Text("${wholeproductdetailsController.productdetailwholemodel?.data?.gst?.toString()??''}",
                                  style: pw.TextStyle(
                                    fontSize: 14,
                                    // fontWeight: pw.FontWeight.w500,
                                  ))
                          ...
                          children: [
                            pw. Column(
                              ...
                              children: [
                                pw.  Text("Tax Amount",),
                                // pw.Text(
                                //   // "${(widget.taxAmount ?? '').toString()}",
                                // ),
                              ],
                            ),
                            pw.Text(
                              (wholemyordercontroller.wholeorderdetailsModel?.data?[0].gst ?? "0.0").toString(),
  ...
  Future<io.File> savePDFToDeviceLocal(String fileName, List<int> pdfBytes) async {
  ...
  void generateAndOpenPDFsummary(BuildContext context) async {
    ...
    // var controller = WholeProfileController();
    // var profileModel = controller.wholemyprofilemodel;
    final logoImageData =
            ...
            child: pw.Column(
              children: [
                pw.Row(mainAxisAlignment: pw.MainAxisAlignment.center,
                  children: [
                    pw.Text("Order Id: ", style: pw.TextStyle(fontSize: 20.0),),
                    pw.Text(widget.orderId.toString(), style: pw.TextStyle(fontSize: 20.0),
                    ),
                  ],
                ),
                ...
                pw.Row(
                  mainAxisAlignment: pw.MainAxisAlignment.center,
                  children: [
                    pw.Text("Date: ", style: pw.TextStyle(fontSize: 20.0,),),
                    pw.Text(
                      DateFormat("dd MMM yyyy").format(DateTime.now()),
                ...
                pw.Row(
                  ...
                  children: [
                    ...
                    pw.Text(
                      // ((wholereviewcontroller.wholeReviewModel?.data?[0].userId?[0].fName ?? '') +' '+
                      //     (wholereviewcontroller.wholeReviewModel?.data?[0].userId?[0].lName ?? '')).trim(),
                        // Get.find<controller name>().modelname
                      (Get.find<WholeProfileController>().wholemyprofilemodel?.data?[0].fName ?? '') +
                          ' ' + (Get.find<WholeProfileController>().wholemyprofilemodel?.data?[0].lName?? ''),
                      style: pw.TextStyle(
                        // color: white,
                        // fontWeight: FontWeight.w400,
                        fontSize: 14.0,
                ...
                pw.Row(
                  ...
                  children: [
                    ...
                    pw.Text(
                      (Get.find<WholeProfileController>().wholemyprofilemodel?.data?[0].email ?? '').toString(),
                      style: pw.TextStyle(
                        // color: white,
                        // fontWeight: FontWeight.w400,
                        fontSize: 14.0,
                ...
                pw.Row(
                  ...
                  children: [
                    ...
                    pw.Text(
                      (Get.find<WholeProfileController>().wholemyprofilemodel?.data?[0].phone ?? ''),
                      style: pw.TextStyle(
                        // color: white,
                        // fontWeight: FontWeight.w400,
                        fontSize: 14.0,
                ...
                pw.Row(
                  ...
                  children: [
                    ...
                    pw.Text(
                      //storage.read('useraddress').toString() + ", " + storage.read('useraddresscity').toString(),
                ...
                Container(
                  ...
                  child:  pw.Padding(
                    ...
                    child:  pw.Column(
                      ...
                      children: [
                        pw.  Text("Order Id", /*style: CustomTextStyle.popinsboldlight,*/),
                        //pw.    Text((wholemyordercontroller.wholeorderdetailsModel?.data?[0].orderId ?? 0).toString(),
                        pw.Text((widget.orderId).toString()),
                        pw. SizedBox(height:10),
                        pw.    Text("Item Name",),
                        pw.Text(widget.variation.toString().replaceAll(RegExp(r'(\\n|\\|\"|\"\")'), '').toString()),
                        pw. SizedBox(height: 10),
                        pw.  Text("Payment",),
                        pw.  Text("Paid:" + widget.paymentmethod.toString(),),
                        pw. SizedBox(height:10),
                        pw. Text("Date",),
                        pw.Text((widget.date).toString()),
                        pw.  SizedBox(height:10),
                        pw. Text("Phone Number",),
                        pw. Text(widget.phone.toString(),),
                        pw. SizedBox(height: 10),
                        pw.  Text("deliver to"),
                        pw. Text(initialDate.add(Duration(days: 7)).toString()),
  ...
  Future<io.File> savePDFToDeviceLocalsummary(String fileNamesummary, List<int> pdfBytessummary) async {
    final dir = await getApplicationDocumentsDirectory();
  ...
  Widget build(BuildContext context) {
    final showLoading = wholemyordercontroller.showLoading;
    return Scaffold(
        ...
        body: Stack(
          children: [
            Padding(
                ...
                //     builder: (_) {
                //       return wholemyordercontroller.wholeorderdetailsModel ==
                //           null||
                ...
                child:ListView(
                      ...
                      children: [
                                      ...
                                      InkWell(
                                          onTap: () async {
                                            ...
                                            orderDetails.Data itemReOrder = orderDetails.Data(
                                              ...
                                              price: '200',
                                              // itemDetails: [
                                              //   ItemDetails(details: 'rgrhgeiugiguliuglilitglii'),
                                              // ],
                                            );

                                            print("Price:  ${widget.itemPrice}");
                                            print("OrderReItem${itemReOrder}");
                                            wholeproductdetailsController.updateReOrder(itemReOrder);
                                            wholeproductdetailsController.ReOrderProduct();
                                            print("OrderItemID*** 103314");
                                            // await addtocartController.init();
                                            // Get.to( AddToCardwhole());
                                          },
                                          child: Container(
                        ...
                        Text("Order Invoice", style: CustomTextStyle.popinssmall014),
                              ...
                              children: [
                                Row(
                                  ...
                                  children: [
                                    ...
                                    Text("₹"+(widget.itemTotal?? '').toString(), style: CustomTextStyle.popinssmall014,
                                    ),
                                  ],
                                ),
                                Divider(
                                ...
                                GestureDetector(
                                  onTap: () {
                                    generateAndOpenPDF(context, widget.itemTotal);
                                  },
                                      ...
                                      Container(
                                          ...
                                          decoration: BoxDecoration(
                                              gradient: LinearGradient(
                                                ...
                                                colors: [Color(0xFFCEE8FC), Color.fromRGBO(206, 232, 252, 0.00)],
                                              ),
                                              borderRadius: BorderRadius.circular(37)),
                                          child: Padding(
                                            padding: const EdgeInsets.all(8.0),
                        ...
                        SizedBox(height: MediaQuery.of(context).size.height * 0.03),
                        Text("Order Summary", style: CustomTextStyle.popinssmall014,),
                        SizedBox(height: MediaQuery.of(context).size.height * 0.01),
                        Container(
                          decoration: BoxDecoration(
                              borderRadius: BorderRadius.circular(15),
                          ...
                          child: Padding(
                            ...
                            child: Column(
                              crossAxisAlignment: CrossAxisAlignment.start,
                              children: [
                                Text("Order Id", style: CustomTextStyle.popinsboldlight,),
                                Text((widget.orderId).toString(), style: CustomTextStyle.popinsboldlightsmall,),

                                SizedBox(height: MediaQuery.of(context).size.height * 0.02),
                                Text("Item Name", style: CustomTextStyle.popinsboldlight,),
                                Text(widget.variation.toString().replaceAll(RegExp(r'(\\n|\\|\"|\"\")'), '')),

                                SizedBox(height: MediaQuery.of(context).size.height * 0.02),
                                Text("Payment", style: CustomTextStyle.popinsboldlight,),
                                Text((widget.paymentmethod).toString(), style: CustomTextStyle.popinsboldlightsmall,),

                                SizedBox(height: MediaQuery.of(context).size.height * 0.02),
                                Text("Date and Time", style: CustomTextStyle.popinsboldlight,),
                                Text((widget.date).toString(), style: CustomTextStyle.popinsboldlightsmall),

                                SizedBox(height: MediaQuery.of(context).size.height * 0.02),
                                Text("Phone Number", style: CustomTextStyle.popinsboldlight,),
                                Text(widget.phone??'', style: CustomTextStyle.popinsboldlightsmall,),

                                SizedBox(height: MediaQuery.of(context).size.height * 0.02),
                                Text("deliver to", style: CustomTextStyle.popinsboldlight,),
                                Text(
                                  initialDate.add(Duration(days: 7)).toString(),
                                          ...
                                          child: Padding(
                                            ...
                                            child: Row(
                                              children: [
                                                Image.asset("assets/image/file.png"),
                                                SizedBox(width: 3),
                                                Text("Download Order Summary", style: CustomTextStyle.popinssmall01),
                                              ],
                                            ),
                                          )),
                        ...
                        SizedBox(height: MediaQuery.of(context).size.height * 0.03),
                        Text("Address", style: CustomTextStyle.popinssmall014,),
                        SizedBox(height: MediaQuery.of(context).size.height * 0.01),
                        Container(
                            decoration: BoxDecoration(
                                borderRadius: BorderRadius.circular(15),
                            ...
                            child: Padding(
                              padding: const EdgeInsets.all(15.0),
                              //child: Text(widget.address.toString(), style: CustomTextStyle.popinsboldlightsmall,),
                              // child: Text(storage.read('UserPrimaryAddress').toString(), style: CustomTextStyle.popinsboldlightsmall,),
                              //child: Text((Get.find<WholeProfileController>().wholemyprofilemodel?.data?[0].d?? '').toString()),
                              child: Text((mycartwholecontroller.address.value??'').toString()),

                            )),

                        SizedBox(height: MediaQuery.of(context).size.height * 0.03),
                        Text("shipping Address", style: CustomTextStyle.popinssmall014,),
                        SizedBox(height: MediaQuery.of(context).size.height * 0.01),
                        Container(
                            decoration: BoxDecoration(
                                borderRadius: BorderRadius.circular(15),
                                      ...
                                      children: [
                                        ...
                                        Container(
                                            ...
                                            decoration: BoxDecoration(
                                                border: Border.all(
                                                    color: MyColors.grey, width: 0.5),
                                                    borderRadius: BorderRadius.circular(25), color: MyColors.white),
                                                    child: Padding(
                                                            padding: const EdgeInsets.all(8.0),
                                                            child: Column(
                                                              crossAxisAlignment: CrossAxisAlignment.start,
                                                              ...
                                                              children: [
                                                                InkWell(onTap: () {
                                                                    ...
                                                                    return AlertDialog(
                                                                      ...
                                                                      content: Form(
                                                                        ...
                                                                        child: Column(
                                                                          ...
                                                                          children: [
                                                                            ...
                                                                            SizedBox(height: 18.0),
                                                                            TextField(
                                                                              controller: wholereviewcontroller.commentController,
                                                                              decoration: InputDecoration(
                                                                                hintText: 'description',
                                                                              ),
                                                                            ),
                                                                            TextField(
                                                                              controller: wholereviewcontroller.ratingController,
                                                                              decoration: InputDecoration(
                                                                                hintText: 'Rating',
                                                                              ),
                                                                            ),
                                                                      ...
                                                                      actions: <Widget>[
                                                                        TextButton(
                                                                          child: Text('Submit'),
                                                                          onPressed: () async {
                                                                            wholereviewcontroller.validateForm(context).then((isValid)  {
                                                                                if (isValid) {
                                                                                  try {
                                                                                    wholereviewcontroller.reviewinit();
                                                                                    Get.back();
                                                                  ...
                                                                  RatingStars(value:0,
                                                                    starBuilder: (index, color) => Icon(
                                                                      Icons.star, color: color, size: 15,),
                                                                      starCount: 5, starSize: 20, maxValue:5,
                                                                      starSpacing: 0.5,
                                                                      maxValueVisibility: true,
                                                                      valueLabelVisibility: false,
                              ...
                              child: Padding(
                                ...
                                child: Column(
                                  ...
                                  children: [
                                    ...
                                    SizedBox(height: 5,),
                                    Text(widget.phone??'', style: CustomTextStyle.popinssmall01)
                                  ],
                                ),
                              )),
                        ),
                        ...
                        InkWell(
                          ...
                          child: Center(
                            child: Container(
                              ...
                              decoration: BoxDecoration(color: MyColors.yellow, borderRadius: BorderRadius.circular(25)),
