...
import 'package:canine/models/wholesalerModel/wholeProductModel.dart';
import 'package:canine/models/wholesalerModel/wholesubModel.dart';
...
Future<void> productInitByCategory() async{
     ...
     try {
         ...
         wholeProductModel = WholeProductModel.fromJson(
          await ApiHelper.getApi("${Constants.BASE_URL}${Constants.API_V1_PATH}${Constants.GET_USER_SUBCATEGORY}"));
