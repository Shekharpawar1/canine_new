...
import 'package:canine/controllers/wholesaler_controller/addresscontroller.dart';
...
import 'package:canine/models/wholesalerModel/addAddressModel.dart';
import 'package:canine/models/wholesalerModel/addressdeleteModel.dart';
import 'package:canine/models/wholesalerModel/mycartListModel.dart';
import 'package:canine/models/wholesalerModel/mycartlistdeleteModel.dart';
...
clearFields();
  ...
  Future<void> alladdressinit() async {
    try {
      ...
      address.value=
      "${wholeallAddresslistModel!.data![0].houseNo},${wholeallAddresslistModel!.data![0].area} ,${wholeallAddresslistModel!.data![0].landmark} , ${wholeallAddresslistModel!.data![0].city}, ${wholeallAddresslistModel!.data![0].state}-${wholeallAddresslistModel!.data![0].pincode}";
      await storage.write("UserPrimaryAddress",address.value);
  ...
  Future<void> placeorderonline() async {
    showLoading = true;
    update();
    MyCartWholeController mycartwholeController =
    Get.put(MyCartWholeController());
    ...
    Map<String, dynamic> body = {
      "user_id": storage.read('wholesalerid').toString(),
      "seller_id": null,"amount":((total)/100).toString(),
      "coupon_discount_amount": ("0.0").toString(),
      "coupon_discount_title":'null',
      "payment_status": "paid",
      "order_status": "pending",
    ...
    String PlaceOrderUrl = Constants.PLACE_ORDER_ONLINE;
    print("Placed order body:${body}");
    try {


      final result=await ApiHelper.postApi(body: body, url: "https://admin.canineproducts.in/api/v1/auth/payment/initiate");
      print("online response $result");
