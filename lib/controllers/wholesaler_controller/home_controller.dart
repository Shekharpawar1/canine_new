...
import 'package:canine/models/wholesalerModel/bannerModel.dart';
import 'package:canine/models/wholesalerModel/ourBrandModel.dart';
...
// }
  ...
  Future<void> init() async {
    ...
    try {
      ...
      userPropertiesModel!.data = userPropertiesModel!.data!.where((element) => element.moduleId == 1 || element.moduleId == 0).toList();
      listLength.value=userPropertiesModel!.data!.length;
      propertyLoaded = true;
      update();
    } catch (e) {
      print('Error: $e');
