...
import 'package:canine/controllers/user_controller/addresscontroller.dart';
import 'package:canine/controllers/user_controller/coupons_controller.dart';
...
import 'package:canine/models/usersModel/addAddressModel.dart';
import 'package:canine/models/usersModel/addressdeleteModel.dart';
import 'package:canine/models/usersModel/mycartListModel.dart';
import 'package:canine/models/usersModel/mycartlistdeleteModel.dart';
...
clearFields();
  ...
  Future<void> placeorderOnline() async {
    ...
    try {
      ...
      final result=await ApiHelper.postApi(body: body, url: "https://canine.hirectjob.in/api/v1/auth/payment/initiate");
