...
import 'package:canine/models/salesmanModel/ourBrandModel.dart';
import 'package:canine/models/usersModel/bannerModel.dart';
...
import 'package:canine/models/usersModel/getUserPropertiesModel.dart' as Model;
import 'package:canine/models/usersModel/ourBrandModel.dart';
import 'package:canine/models/usersModel/partnerModel.dart';
import 'package:canine/models/usersModel/servicesCategoriesModel.dart';
import 'package:canine/models/usersModel/userProductByPartnerItemModel.dart';
import 'package:canine/models/usersModel/userProductByPartnerModel.dart';
import 'package:canine/models/usersModel/userWishListModel.dart';
...
import 'package:canine/models/usersModel/servicesModel.dart';
...
RxString ServiceDescription=''.obs;
  List<Model.Data> searchScreenData = [];
  ...
  void searchDataFilter(UserPropertiesModel? dataModel, String keyword) {
    ...
    List<Model.Data> filteredData = filter(keyword, dataModel!.data!);
  ...
  List<Model.Data> filter(String key, List<Model.Data> data) {
    Set<Model.Data> finalData = {};
