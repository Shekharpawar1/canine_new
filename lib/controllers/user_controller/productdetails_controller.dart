...
import 'package:canine/models/usersModel/cardItemModel.dart';
...
// }
      ...
      //   return sum + (int.tryParse(productdetailmodel!.data!.price.toString()) ?? 0);
      // });
      ...
      //   return sum + (int.tryParse(productdetailmodel!.data!.discount.toString()) ?? 0);
      // });
  ...
  //   total = 0;
  //   for (var product in productdetailmodel!.data!.suggestionProduct!) {
  //     num price = productdetailmodel!.data!.price ?? 0;
  //     num discount = productdetailmodel!.data!.discount ?? 0;
  //
...
// }
  ...
  //   print("tityoy6o--------------${addProductCombo}");
  //   showLoading = true;
  //   update();
  //
  //   String? itemName;
