class Constants {
  ...
  // static const BASE_URL = "https://caninedemo.caninetest/.xyz";
  static const BASE_URL="https://admin.canineproducts.in";
  ...
  static const ADD_PRODUCT =
    ...
    static const ADD_COMBO_PRODUCT =
      ...
      "$BASE_URL${API_V1_PATH}/auth/add_amount";
         static const PLACE_ORDER_ONLINE =
      "$BASE_URL${API_V1_PATH}/auth/payment/initiate";
